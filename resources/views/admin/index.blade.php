...
<body>
        ...
        <div class="content">
            ...
            <div class="table_post">
                ...
                <div class="footer_control">
                    <div class="el_1 footer_element" data-url="@if (isset($search)) /{{ env('FOR_ADMIN_URL') }}?page=1&search={{ $search }} @else/{{ env('FOR_ADMIN_URL') }}?page=1 @endif">
                    ...
                    <div class="el_2 footer_element" data-url="@if (isset($search)) /{{ env('FOR_ADMIN_URL') }}?page=1&search={{ $search }} @else/{{ env('FOR_ADMIN_URL') }}?page=1 @endif">
                    ...
                    <div class="el_5 footer_element" data-url="@if (isset($search)) /{{ env('FOR_ADMIN_URL') }}?page=1&search={{ $search }} @else/{{ env('FOR_ADMIN_URL') }}?page=1 @endif">
                        <svg width=" 20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div class="el_4 footer_element" data-url="@if (isset($search)) /{{ env('FOR_ADMIN_URL') }}?page=1&search={{ $search }} @else/{{ env('FOR_ADMIN_URL') }}?page=1 @endif">
                        <svg width="13" height="20" viewBox="0 0 13 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
    ...
    <script>
        document.querySelector('.table_post').addEventListener('click', function(e) {
            if (e.target.classList.contains('delete') || e.target.closest('span.delete').classList.contains('delete')) {
        ...
        document.querySelector('.search').addEventListener('keypress', function(event) {
            if (event.key == 'Enter') {
                ...
                window.location.href = `{{ env('FOR_ADMIN_URL') }}?search=${search}`;
            }
        })
    </script>
</body>
